        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-12">
          <div className="order-2 lg:order-1">
            <PolicySection icon={Shield} title="Introduction" id="introduction">
              <p>
                At NeonCloud, we take your privacy seriously. This Privacy Policy explains how we collect, 
                use, disclose, and safeguard your information when you use our cloud computing services, 
            ...
            <PolicySection icon={Database} title="Information Collection" id="information-collection">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>Technical Data (server configurations, performance metrics)</li>
                <li>Payment Information (processed through secure payment providers)</li>
              </ul>
            </PolicySection>

            <PolicySection icon={Eye} title="Information Usage" id="information-usage">
            ...
            <PolicySection icon={Share2} title="Information Sharing" id="information-sharing">
              <p>
