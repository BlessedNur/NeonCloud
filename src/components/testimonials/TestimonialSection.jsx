...
const TestimonialCarousel = () => {
  ...
  const testimonials = [
    {
      content:
        "NeonCloud has revolutionized our hosting experience. The performance boost and reliability have directly contributed to our 40% increase in user engagement.",
    ...
    {
      content:
        "Moving to NeonCloud was the best decision for our e-commerce platform. The loading speeds are incredible, and the support team is always there when we need them.",
      author: "Michael Lee",
    ...
    {
      content:
        "The advanced security features and automated backups give us peace of mind. Our development team can focus on innovation rather than infrastructure management.",
      author: "Emily Chen",
    ...
    {
      content:
        "NeonCloud's scalability features handled our Black Friday surge flawlessly. Zero downtime and consistent performance under heavy loads.",
      author: "David Brown",
    ...
    {
      content:
        "The migration process was seamless, and the performance improvement was immediate. Our site's load time decreased by 60%.",
      author: "Lisa Wong",
  ...
  const nextSlide = () => {
    setCurrentIndex(
      (prevIndex) => (prevIndex + 1) % (testimonials.length - visibleCards + 1)
    );
  };
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="mt-4 text-gray-400">
            Join thousands of satisfied customers who trust NeonCloud with their
            digital presence
          </p>
        </div>
        ...
        <div className="flex justify-center mt-6 md:mt-10 space-x-2">
          {[...Array(testimonials.length - visibleCards + 1)].map(
            (_, index) => (
              <button
                key={index}
